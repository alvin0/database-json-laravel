...
class DatabaseTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers DatabaseJson\Classes\Database::create
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::remove
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::table
     * @expectedException DatabaseJson\Classes\DatabaseJsonException
    ...
    public function testTableExists()
    {
        ...
        $this->assertInstanceOf('DatabaseJson\Classes\Database', $table);
        $this->assertEquals('users', $table->name());
        return $this->object->table('users');
    }

    /**
     * @covers DatabaseJson\Classes\Database::findAll
     * @depends testTableExists
     */
    public function testFindAll($table)
    {
        $results = $table->findAll();
        $this->assertInstanceOf('DatabaseJson\Classes\Database', $results);
        $this->assertSame(4, count($results));
    }

    /**
     * @covers DatabaseJson\Classes\Database::find
     * @covers DatabaseJson\Classes\Database::getRowKey
     * @depends testTableExists
     */
    public function testFind($table)
    {
        ...
        $result[] = $table->find();
        $this->assertInstanceOf('DatabaseJson\Classes\Database', $result[0]);
        $this->assertSame(1, count($result[0]));

        $result[] = $table->find(2);
        $this->assertInstanceOf('DatabaseJson\Classes\Database', $result[1]);
        $this->assertSame(1, count($result[1]));
        $this->assertSame(2, $result[1]->id);
    }

    /**
     * DatabaseJson\Classes\Database::asArray
     * @depends testTableExists
     */
    ...
    /**
     * DatabaseJson\Classes\Database::count
     * @depends testTableExists
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::limit
     * @covers DatabaseJson\Classes\Database::limitPending
     * @depends testTableExists
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::orderBy
     * @covers DatabaseJson\Classes\Database::orderByPending
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::where
     * @covers DatabaseJson\Classes\Database::orWhere
     * @covers DatabaseJson\Classes\Database::andWhere
     * @covers DatabaseJson\Classes\Database::wherePending
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::groupBy
     * @covers DatabaseJson\Classes\Database::groupByPending
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::addFields
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::deleteFields
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::save
     * @covers DatabaseJson\Classes\Database::__set
     * @covers DatabaseJson\Classes\Database::__get
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::delete
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Database::__isset
     */
