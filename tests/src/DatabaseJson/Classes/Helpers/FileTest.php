...
class FileTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers DatabaseJson\Classes\Helpers\File::table
     */
    public function testTable()
    {
        $object = $this->object->table('users');
        $this->assertInstanceOf('DatabaseJson\Classes\Helpers\File', $object);
        return $object;
    }

    /**
     * @covers DatabaseJson\Classes\Helpers\File::getPath
    ...
    {
        $object->setType('data');
        $this->assertSame(DatabaseJson_DATA_PATH . 'users.data.json', $object->getPath());
        return $object;
    }

    /**
     * @covers DatabaseJson\Classes\Helpers\File::get
     * @depends testTable
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Helpers\File::put
     * @depends testGetPath
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Helpers\File::exists
     * @depends testGetPath
     */
    ...
    /**
     * @covers DatabaseJson\Classes\Helpers\File::remove
     */
