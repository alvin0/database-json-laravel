...
class DatabaseTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers \DatabaseJson\Core\Database::create
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::remove
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::table
     * @expectedException \DatabaseJson\Core\Helpers\Exception
    ...
    public function testTableExists()
    {
        ...
        $this->assertInstanceOf('DatabaseJson\Core\Database', $table);
        $this->assertEquals('users', $table->name());
        return $this->object->table('users');
    }

    /**
     * @covers \DatabaseJson\Core\Database::findAll
     * @depends testTableExists
     */
    public function testFindAll($table)
    {
        $results = $table->findAll();
        $this->assertInstanceOf('DatabaseJson\Core\Database', $results);
        $this->assertSame(4, count($results));
    }

    /**
     * @covers \DatabaseJson\Core\Database::find
     * @covers \DatabaseJson\Core\Database::getRowKey
     * @depends testTableExists
     */
    public function testFind($table)
    {
        ...
        $result[] = $table->find();
        $this->assertInstanceOf('DatabaseJson\Core\Database', $result[0]);
        $this->assertSame(1, count($result[0]));

        $result[] = $table->find(2);
        $this->assertInstanceOf('DatabaseJson\Core\Database', $result[1]);
        $this->assertSame(1, count($result[1]));
        $this->assertSame(2, $result[1]->id);
    }

    /**
     * DatabaseJson\Core\Database::asArray
     * @depends testTableExists
     */
    ...
    /**
     * DatabaseJson\Core\Database::count
     * @depends testTableExists
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::limit
     * @covers \DatabaseJson\Core\Database::limitPending
     * @depends testTableExists
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::orderBy
     * @covers \DatabaseJson\Core\Database::orderByPending
     */
...
//        $this->assertSame(1, reset($query[4])['id']);
    ...
    /**
     * @covers \DatabaseJson\Core\Database::where
     * @covers \DatabaseJson\Core\Database::orWhere
     * @covers \DatabaseJson\Core\Database::andWhere
     * @covers \DatabaseJson\Core\Database::wherePending
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::groupBy
     * @covers \DatabaseJson\Core\Database::groupByPending
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::addFields
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::deleteFields
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::save
     * @covers \DatabaseJson\Core\Database::__set
     * @covers \DatabaseJson\Core\Database::__get
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::set
     * @covers \DatabaseJson\Core\Database::save
     * @covers \DatabaseJson\Core\Database::__get
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::insert
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::delete
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::getField
     * @covers \DatabaseJson\Core\Database::setField
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::__isset
     */
    ...
    /**
     * @covers \DatabaseJson\Core\Database::issetField
     */
