...
interface FileInterface
{
     ...
     * @throws DatabaseJsonException You must specify the type of file
     */
     ...
     * Removing file
     * @return boolean
     * @throws DatabaseJsonException If file doesn't exists or there's problems with deleting files
     */
