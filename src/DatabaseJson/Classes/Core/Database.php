...
use DatabaseJson\Classes\Helpers;
...
abstract class Core_Database implements \IteratorAggregate, \Countable
{
     ...
     * @see \DatabaseJson\Classes\Core_Database::setPending()
     * @var array
     */
    protected $pending;
     ...
     * @see \DatabaseJson\Classes\Core_Database::setPagination()
     * @var array
     */
     ...
     * @return array
     */
    public function toArrayWithPaginate()
    {
        return [
     ...
     * @return \DatabaseJson\Classes\Database
     * @throws DatabaseJsonException If there's problems with load file
     */
    ...
    /**
     * Get rows from table
     * @uses DatabaseJson\Classes\Helpers\Data::get() to get data from file
     * @return array
     */
     ...
     * @throws DatabaseJsonException If there's no data with that ID
     */
     ...
     * @uses DatabaseJson\Classes\Helpers\Validate::isNumeric() to check if type of field is numeric
     */
     ...
     * @uses DatabaseJson\Classes\Helpers\Validate::field() to check that field exist
     * @uses DatabaseJson\Classes\Helpers\Validate::type() to check that field type is correct
    ...
    public function __get($name)
    {
        ...
        throw new DatabaseJsonException('There is no data');
    }
     ...
     *
     * @uses DatabaseJson\Classes\Helpers\Data::arrToLower() to lower case keys and values of array
     * @uses DatabaseJson\Classes\Helpers\Data::exists() to check if data file exists
     * @uses DatabaseJson\Classes\Helpers\Config::exists() to check if config file exists
     * @uses DatabaseJson\Classes\Helpers\Validate::types() to check if type of fields are correct
     * @uses DatabaseJson\Classes\Helpers\Data::put() to save data file
     * @uses DatabaseJson\Classes\Helpers\Config::put() to save config file
     * @param string $name Table name
     * @param array $fields Field configuration
     * @throws DatabaseJsonException If table exist
     */
    public static function create($name, array $fields)
    {
        ...
        if (Helpers\Data::table($name)->exists() && Helpers\Config::table($name)->exists()) {
            throw new DatabaseJsonException('Table ' . $name . ' already exist');
        }
     ...
     * @uses DatabaseJson\Classes\Helpers\Data::remove() to remove data file
     * @uses DatabaseJson\Classes\Helpers\Config::remove() to remove config file
     * @param string $name Table name
     * @return boolean|DatabaseJsonException
     */
     ...
     * @param string $column
     * @return \DatabaseJson\Classes\Core_Database
     */
...
//         $this->setFields();
    ...
    {
        $print = "DatabaseJson::table(" . $this->name . ")\n";
