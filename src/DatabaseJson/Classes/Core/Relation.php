...
use DatabaseJson\Classes\Helpers\Config;
use DatabaseJson\Classes\Helpers\Validate;
...
abstract class Core_Relation
{
     ...
     * @return \DatabaseJson\Classes\Relation
     */
     ...
     * @return \DatabaseJson\Classes\Core_Relation
     * @throws DatabaseJsonException First you must define tables name
     */
    protected function setKey($type, $key)
    {
        ...
        throw new DatabaseJsonException('First you must define tables name');
    }
     ...
     * @throws DatabaseJsonException Tables names or keys missing
     */
    public function setRelation()
    {
        if (!in_array(null, $this->tables) && !in_array(null, $this->keys)) {
            ...
            throw new DatabaseJsonException('Tables names or keys missing');
        }
    }
